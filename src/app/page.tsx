    ...
    const content = [
		{
			title: "أدخل بياناتك",
			description:
				"أضف معلومات شركتك وعملائك بسهولة. يمكنك إضافة الشعار والعنوان ومعلومات التواصل بشكل سريع وسهل.",
			content: (
		...
		},
		{
			title: "أضف خدماتك",
			description:
				"اختر من قائمة الخدمات أو أضف خدماتك الخاصة. حدد الأسعار والكميات بكل سهولة وأضف الضريبة تلقائياً.",
			content: (
		...
		},
		{
			title: "اختر التصميم",
			description:
				"اختر من مجموعة متنوعة من التصاميم الاحترافية. خصص ألوان وتنسيق فاتورتك بما يناسب هويتك التجارية.",
			content: (
		...
		},
		{
			title: "حمّل فاتورتك",
			description:
				"احفظ فاتورتك بصيغة PDF أو اطبعها مباشرة. شاركها مع عملائك عبر البريد الإلكتروني أو الواتساب بضغطة زر.",
			content: (
				<div className="flex h-full w-full items-center justify-center bg-[linear-gradient(to_bottom_right,var(--cyan-500),var(--emerald-500))] text-white">
					تحميل الفاتورة
				</div>
			...
			<div className="  relative " id="home">
				...
				<div className="flex flex-col items-center justify-center gap-10 mb-60">
					...
					>
						<Iphone15Pro
							className="size-1/6"
							src="gradient-dark-mode-app-template.png"
						/>
						<Safari
							className="size-1/2"
							url="Bilfora.com"
							imageSrc="pc-dashboard.jpeg"
						/>
					</motion.div>
				</div>
				{/* how does it work ? */}
